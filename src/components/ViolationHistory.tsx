...
import { Calendar, Download, Filter, Search, Camera, Clock } from 'lucide-react';
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-slate-600">View and manage all detected violations across your locations</p>
      </div>
      ...
      <Card className="p-6">
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-slate-600">{violations.length} total violations found</p>
          </div>
        </div>
                ...
                <div className="flex items-start justify-between gap-4 mb-2">
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-sm text-slate-500">#{violation.id}</span>
                    </div>
