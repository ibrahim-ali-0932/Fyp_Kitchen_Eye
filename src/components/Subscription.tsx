...
import { Check, Zap, Crown, Building2, Camera, Users, FileText, BarChart3 } from 'lucide-react';
      ...
      <Card className="p-8 max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-sm text-slate-600">We accept all major credit cards, PayPal, and bank transfers for Enterprise plans.</p>
          </div>
          <div>
            <h3 className="mb-2">Is there a free trial?</h3>
            <p className="text-sm text-slate-600">Yes, all paid plans come with a 14-day free trial. No credit card required.</p>
          </div>
          <div>
            <h3 className="mb-2">What happens to my data if I downgrade?</h3>
            <p className="text-sm text-slate-600">Your data is retained according to your new plan's retention policy. We recommend exporting reports before downgrading.</p>
          </div>
        </div>
      </Card>
