...
import { Camera, Shield, TrendingUp, CheckCircle, Users, Bell, FileText, ArrowRight, Sparkles, Zap } from 'lucide-react';
      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button onClick={onGetStarted} className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 shadow-lg shadow-blue-500/30">
                Get Started
              </Button>
            </motion.div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              Real-time AI detection for spills, PPE violations, pests, and fire hazards. Keep your kitchen safe and compliant 24/7.
            </motion.p>
            ...
            >
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button size="lg" variant="outline" onClick={onSignIn} className="border-2 hover:border-blue-600 hover:text-blue-600">
                  Sign In
                </Button>
              </motion.div>
            </motion.div>
            ...
            >
              {[
                ...
                >
                  <div className="text-2xl bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">{stat.value}</div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 relative z-10">
        ...
        >
          ...
          >
            ...
            <p className="text-xl text-slate-600">Comprehensive AI monitoring for all safety risks</p>
          </motion.div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
            {[
              { icon: '🧤', title: 'PPE Violations', desc: 'Missing gloves, hairnets, masks', gradient: 'from-orange-500 to-red-500' },
              { icon: '💧', title: 'Spills', desc: 'Floor hazards and liquid spills', gradient: 'from-blue-500 to-cyan-500' },
              { icon: '🐀', title: 'Pest Detection', desc: 'Rodents and insects', gradient: 'from-red-500 to-pink-500' },
              { icon: '🔥', title: 'Fire Hazards', desc: 'Smoke and fire detection', gradient: 'from-purple-500 to-pink-500' }
            ].map((item, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 30 }}
        ...
        >
          ...
          <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl p-12 border-2 shadow-2xl">
            ...
            >
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button size="lg" variant="outline" className="border-2 hover:border-blue-600 hover:text-blue-600">
                  Schedule Demo
                </Button>
              </motion.div>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          >
            <div>
              ...
              <p className="text-sm text-slate-300">AI-powered hygiene monitoring for modern kitchens</p>
            </div>
            <div>
